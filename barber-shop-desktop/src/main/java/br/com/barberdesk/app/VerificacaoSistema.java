 ...
 * <p>
 * Uso: {@code mvn -pl barber-shop-desktop exec:java -Dexec.mainClass=br.com.barberdesk.app.VerificacaoSistema}
 * ou, a partir do jar:
 * {@code java -cp barber-shop-desktop/target/barber-shop-desktop-1.0-SNAPSHOT.jar br.com.barberdesk.app.VerificacaoSistema}.
        ...
        try {
            ...
            checar("Criação de agendamento", () -> {
                ...
                Agendamento agendamento = new Agendamento(barbeariaRef[0].getId(), servicoRef[0].getId(), barbeiroRef[0].getId(),
                        "Cliente Verificação", "11999999999", dataHora, OrigemContato.OUTRO, StatusAgendamento.AGENDADO);
